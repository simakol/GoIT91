...
// const student = new Student("Петрик", "Пяточкин", 2023);
// console.log(student);
...
//   static addHero() {
//     this.counter += 1;
//     console.log(`Додали нового героя, кількість героїв: ${this.counter}`);
//   }
...
//   attack() {
//     console.log(`Герой ${this.name} наніс пошкодження в розмірі 10 одиниць`);
//   }
...
// const igotron = new Hero("Igotron");
